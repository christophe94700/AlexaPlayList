...
// Mot de passe 123Admin@
$auth_users = array(
    'admin' => '$2y$10$BC031KKpHttofcD8c/AaUOogy9ONPMWIQkopsitlvH1Ks.xXGQMj.', //
	 'user' => '$2y$10$BC031KKpHttofcD8c/AaUOogy9ONPMWIQkopsitlvH1Ks.xXGQMj.',
);
...
$dir_php='';//exemple '/mp3
//Répertoire d'installation des fichiers mp3
$dir_media='/files';

// Root path for file manager
// use absolute path of directory i.e: '/var/www/folder' or $_SERVER['DOCUMENT_ROOT'].'/folder'
$root_path = $_SERVER['DOCUMENT_ROOT'].$dir_php.$dir_media;
...
$exclude_items = array('*.php','.htaccess'); // Hiden file
...
$hide_Ligne=4; // Number hidden ligne to htacces file
?>
